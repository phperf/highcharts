...
use Phperf\HighCharts\LangRu;
use Phperf\HighCharts\Series;
use Phperf\HighCharts\Table;
...
class ChartTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        //var_export(View_HighCharts_(new Series)->exportOptions());

        $this->assertSame(
            '{"data":[]}',
            json_encode((new Series)->exportOptions())
        );

// http://www.highcharts.com/demo/arearange-line
        $this->assertSame(
            '{"data":[],"name":"test"}',
            json_encode((new Series)
                ->setName('test')
                ->exportOptions())
        );
...
EOD;
    ...
    public function testAutoId()
    {
        ...
        //View_HighCharts_(new Table($rows))->setId('test')->withNamedSeries()->render();
        //return;
...
(function(){
    ...
    var chart = $('#highcharts-0').highcharts({"title":false,"chart":{"zoomType":"x"},"legend":{"enabled":true,"verticalAlign":"top"},"plotOptions":{"series":{"marker":{"enabled":false}}},"tooltip":{"crosshairs":[true,true],"shared":false},"credits":{"enabled":false},"series":[]}).highcharts();
...
EOD;
        $this->assertSame($e, (string)(new Table($rows))->withNamedSeries());
...
(function(){
    ...
    var chart = $('#highcharts-1').highcharts({"title":false,"chart":{"zoomType":"x"},"legend":{"enabled":true,"verticalAlign":"top"},"plotOptions":{"series":{"marker":{"enabled":false}}},"tooltip":{"crosshairs":[true,true],"shared":false},"credits":{"enabled":false},"series":[]}).highcharts();
    chart.addSeries({"data":[[1,112],[2,114]],"id":"serie 1","name":"serie 1"}, false);
    chart.addSeries({"data":[[2,117],[3,113]],"id":"serie 2","name":"serie 2"}, false);
    chart.redraw();
})();
...
EOD;
    ...
    public function testRegular()
    {
        ...
        //View_HighCharts_(new Table($rows))->setId('test')->render();
        //return;
...
EOD;
        $this->assertSame($e, (string)(new Table($rows)));


        $iterator = new \ArrayIterator($rows);
        $this->assertSame($e, (string)(new Table($iterator))->setId('highcharts-2'));
    }
...
EOD;
        ...
        $this->assertSame($e, (string)(new Table($rows))->setId('test')->withNamedSeries());
        ...
        $iterator = new \ArrayIterator($rows);
        $this->assertSame($e, (string)(new Table($iterator))->setId('test')->withNamedSeries());


        $rowsCombined = Processor::create($rows)->combineOffset(2, 1);
        $this->assertSame($e, (string)(new Table($rowsCombined))->setId('test'));
...
EOD;
    ...
    public function testCallbackOption()
    {
        ...
        $c->addOption('xAxis', 'events', 'afterSetExtremes', new RawJson('loadPoints'));
...
Highcharts.setOptions({"global":{"useUTC":false}});
    ...
    var chart = $('#highcharts-3').highcharts({"title":false,"chart":{"zoomType":"x"},"legend":{"enabled":true,"verticalAlign":"top"},"plotOptions":{"series":{"marker":{"enabled":false}}},"tooltip":{"crosshairs":[true,true],"shared":false},"credits":{"enabled":false},"xAxis":{"events":{"afterSetExtremes":loadPoints,"setExtremes":setExtremesCallback}},"series":[]}).highcharts();
    chart.addSeries({"data":[[1,2]],"id":"default","name":"default"}, false);
    chart.redraw();
})();
</script>
EOD;
        ...
        $this->assertSame($expected, (string)$c);
...
(function(){
    ...
    var chart = $('#highcharts-3').highcharts({"title":{"text":"My Title"},"chart":{"zoomType":"x","type":"column"},"legend":{"enabled":true,"verticalAlign":"top"},"plotOptions":{"series":{"marker":{"enabled":false}}},"tooltip":{"crosshairs":[true,true],"shared":false},"credits":{"enabled":false},"xAxis":{"title":{"text":"My X Title"}},"yAxis":{"title":{"text":"My Y Title"}},"series":[]}).highcharts();
    chart.redraw();
})();
</script>
EOD;
...
(function(){
    ...
    var chart = $('#highcharts-3').highcharts({"title":false,"chart":{"zoomType":"x"},"legend":{"enabled":true,"verticalAlign":"top"},"plotOptions":{"series":{"marker":{"enabled":false}}},"tooltip":{"crosshairs":[true,true],"shared":false},"credits":{"enabled":false},"series":[]}).highcharts();
